...
\newline Document that NumPy may need a copy in that case.
  ...
  \item The benchmark prints storage bytes and mutation propagation rather than assuming \code{reshape} always returns a view.
        \end{itemize}
        \end{evidencebox}
  ...
  \item Reject a batch whose trailing dimensions are not $(28,28)$.
        \end{itemize}
