...
NumPy floating dtype.  Cast the values first, then compute the forward neighbor
...
negative values, NaN, and infinity.
  ...
  \item The benchmark draws three dtype curves and prints spacing ratios; interpretation replaces a fabricated pass threshold.
        \end{itemize}
        \end{evidencebox}
