...
\code{sum}, and \code{math.fsum}; do not claim Kahan is correctly rounded for
every adversarial sequence.
  ...
  \item The benchmark prints signed errors and order sensitivity for each reduction separately.
        \end{itemize}
        \end{evidencebox}
  ...
  \item Reject empty, non-vector, non-float64, or nonfinite input.
        \end{itemize}
