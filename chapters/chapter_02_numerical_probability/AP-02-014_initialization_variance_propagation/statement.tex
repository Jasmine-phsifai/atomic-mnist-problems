...
trials.
  ...
  \item The benchmark prints repeated-trial mean and spread, making sampling noise visible rather than hiding it behind one pass/fail number. (Trust-based: the test suite does not machine-check benchmark output.)
        \end{itemize}
        \end{evidencebox}
  ...
  \item Reject non-positive fan dimensions or an unknown scheme with \code{ValueError}.
